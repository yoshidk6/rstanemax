...
This small package performs simple sigmoidal Emax model fit using Stan, without the need of writing Stan model code (and also compiling Stan model), inspired by __rstanarm__ package.
