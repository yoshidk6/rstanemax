...
test_that("manual prior set", {
  ...
  expect_error(set_prior(test.standata.noprior, priors = list(ec50  = c(1))),
               "Priors need to be defined with length 2 numeric vectors")
  expect_error(set_prior(test.standata.noprior, priors = list(emax  = c(1,2,3))),
               "Priors need to be defined with length 2 numeric vectors")
  expect_error(set_prior(test.standata.noprior, priors = list(e0  = "test")),
               "Priors need to be defined with length 2 numeric vectors")
})
